...
class ControllerGerenciarFuncionariosM extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('TelaGerenciarFuncionariosM', compact('funcionarios'));
    }
    ...
    {
        $funcionarios = Funcionario::all();
        return view('TelaCadastroFuncionarioMinistra', compact('funcionarios'));
    }
    ...
    public function store(Request $request){
        ...
        $funcionarios->save();
        return redirect()->route('funcionariosM.index');
    ...
    {
        return view('TelaEditarFuncionarioMinistra', compact('funcionarios'));
    }
